...
public class HibanaCharacter : MonoBehaviour {
    ...
    [SerializeField] private float m_DoubleJumpForce = 300f;            // Amount of force added when the player double jumps.
    ...
    private bool m_DoubleJumpEnable = true;
 ...
 //       m_CeilingCheck = transform.Find("CeilingCheck");
    ...
    public void Move(float move, bool jump, bool attack)
    {
        ...
        m_Anim.SetBool("Attacking", (attack && !m_Anim.GetBool("Attacking")));
    }
